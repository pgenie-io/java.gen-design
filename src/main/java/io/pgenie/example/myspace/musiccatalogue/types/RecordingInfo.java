...
/**
 * Representation of the {@code recording_info} user-declared PostgreSQL composite (record) type.
 *
...
public record RecordingInfo(
    String studioName, String city, String country, LocalDate recordedDate) {

  public static final CompositeCodec<RecordingInfo> CODEC =
      new CompositeCodec<>(
          "public",
          "recording_info",
          (String studioName) ->
              (String city) ->
                  (String country) ->
                      (LocalDate recordedDate) ->
                          new RecordingInfo(studioName, city, country, recordedDate),
