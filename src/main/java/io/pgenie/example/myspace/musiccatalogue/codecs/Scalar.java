...
public interface Scalar<A> {
   ...
   * 
   * This is primarily used for encoding fields in composite types. Unfortunately,
   * the PostgreSQL JDBC driver does not support natively encoding composite types
   * or the binary format for them.
   */
