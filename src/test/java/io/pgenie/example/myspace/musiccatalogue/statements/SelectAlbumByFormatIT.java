...
class SelectAlbumByFormatIT extends AbstractDatabaseIT {
  ...
  void selectAlbumByFormatFindsInsertedAlbum() throws SQLException {
    var recording = new RecordingInfo("Record Plant", "Sausalito", "USA", LocalDate.of(1976, 8, 1));
    var inserted =
        execute(new InsertAlbum("Rumours", LocalDate.of(1977, 2, 4), AlbumFormat.CD, recording));
